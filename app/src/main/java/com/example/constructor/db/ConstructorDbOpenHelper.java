    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(
                "CREATE TABLE IF NOT EXISTS " + ConstructorReaderContract.AnswerEntry.TABLE_NAME + " (" +
                        ...
                        "(" + ConstructorReaderContract.QuestionEntry.COLUMN_ID + ")" + ");"
        );

        sqLiteDatabase.execSQL(
                "CREATE TABLE IF NOT EXISTS " + ConstructorReaderContract.ChapterEntry.TABLE_NAME + " (" +
                        ConstructorReaderContract.ChapterEntry.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
        ...
        sqLiteDatabase.execSQL(
                "CREATE TABLE IF NOT EXISTS " + ConstructorReaderContract.ImageUrlEntry.TABLE_NAME + " (" +
                        ConstructorReaderContract.ImageUrlEntry.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        ...
                        "(" + ConstructorReaderContract.ContentChapterEntry.COLUMN_ID + ")" + ");"
        );

        sqLiteDatabase.execSQL(
                "CREATE TABLE IF NOT EXISTS " + ConstructorReaderContract.LinkUrlEntry.TABLE_NAME + " (" +
                        ConstructorReaderContract.LinkUrlEntry.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
        ...
        sqLiteDatabase.execSQL(
                "CREATE TABLE IF NOT EXISTS " + ConstructorReaderContract.TestEntry.TABLE_NAME + " (" +
                        ConstructorReaderContract.TestEntry.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
